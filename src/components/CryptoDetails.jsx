    ...
    <>
      <Col className="coin-detail-container">
        <Col className="coin-heading-container">
          ...
          <p>
            Track live {cryptoDetails.name} prices(in $) View market cap,market supply and
            value statistics.
          </p>
        </Col>
        <Select
        ...
        <LineChart coinHistory={coinHistory} currentPrice={millify(cryptoDetails.price)} timePeriod={timePeriod} coinName={cryptoDetails.name}/>
        <Col className="stats-container">
          <Col className="coin-value-statistics">
            ...
            {stats.map(({icon,title,value})=>{
             return <Col className="coin-stats" key={title}>
        ...
        <Col className="coin-desc-link">
          ...
          <Col className="coin-links">
            ...
            {cryptoDetails.links.map((link)=>{
              return <Row className="coin-link" key={link.url}>
